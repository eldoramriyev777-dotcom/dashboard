...
const CustomersComponant = () => <ResponsiveDrawer />;

export default CustomersComponant;
    ...
    <Box sx={{ display: 'flex', backgroundColor: "#f9f9f9" }}>
      ...
      <AppBar position="fixed" sx={{ width: { sm: `calc(100% - ${drawerWidth}px)` }, ml: { sm: `${drawerWidth}px` }, bgcolor: "white", color: "black" }}>
        <Toolbar sx={{ display: "flex", justifyContent: "space-between" }}>
          <Typography sx={{ fontSize: 24, fontWeight: 800 }}>Customers</Typography>
          ...
          >
            <Grid item xs={12} sm={6} md={3} sx={{ flex: 1 }}>
              <Card sx={{ p: 2, borderRadius: 3, boxShadow: 3, width: "100%" }}>
                <CardContent>
                  ...
                  <Typography sx={{ fontSize: 28, fontWeight: 700 }}>0</Typography>
                </CardContent>
              </Card>
            </Grid>
            ...
            <Grid item xs={12} sm={6} md={3} sx={{ flex: 1 }}>
              <Card sx={{ p: 2, borderRadius: 3, boxShadow: 3, width: "100%" }}>
                <CardContent>
                  <Box sx={{ display: "flex", justifyContent: "space-between", mb: 1 }}>
                    <Typography sx={{ color: "#1e40af", fontWeight: 600 }}>Inactive</Typography>
                    <PeopleAltIcon sx={{ color: "#1e40af", fontSize: 26 }} />
                  </Box>
                  <Typography sx={{ fontSize: 28, fontWeight: 700 }}>1</Typography>
                </CardContent>
              </Card>
            </Grid>
            ...
            <Grid item xs={12} sm={6} md={3} sx={{ flex: 1 }}>
              <Card sx={{ p: 2, borderRadius: 3, boxShadow: 3, width: "100%" }}>
                <CardContent>
                  <Box sx={{ display: "flex", justifyContent: "space-between", mb: 1 }}>
                    <Typography sx={{ color: "#1e40af", fontWeight: 600 }}>This month</Typography>
                    <PeopleAltIcon sx={{ color: "#1e40af", fontSize: 26 }} />
                  </Box>
                  <Typography sx={{ fontSize: 28, fontWeight: 700 }}>+1</Typography>
                </CardContent>
