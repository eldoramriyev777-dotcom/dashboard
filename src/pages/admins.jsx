...
const AdminsComponant = () => <ResponsiveDrawer />;

export default AdminsComponant;
    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <AppBar position="fixed" sx={{ width: { sm: `calc(100% - ${drawerWidth}px)` }, ml: { sm: `${drawerWidth}px` }, bgcolor: "white", color: "black" }}>
        <Toolbar sx={{ display: "flex", justifyContent: "space-between" }}>
          <Typography sx={{ fontSize: 24, fontWeight: 800 }}>Admins</Typography>
      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3, width: { sm: `calc(100% - ${drawerWidth}px)` } }}>
        ...
        <Typography sx={{ mb: 2 }}>Manage your customer account</Typography>
