...
const DashboardComponant = () => <ResponsiveDrawer />;
...
export function ResponsiveDrawer(props) {
  ...
  const data = [
    ...
    { name: "May", customers: 370 },
    { name: "Jun", customers: 280 },
    { name: "Jul", customers: 480 },
    { name: "Aug", customers: 460 },
    { name: "Sep", customers: 500 },
  ];
    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <AppBar position="fixed" sx={{ width: { sm: `calc(100% - ${drawerWidth}px)` }, ml: { sm: `${drawerWidth}px` }, bgcolor: "white", color: "black" }}>
        <Toolbar sx={{ display: "flex", justifyContent: "space-between" }}>
          <Typography sx={{ fontSize: 24, fontWeight: 800 }}>Dashboard</Typography>
      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3, width: { sm: `calc(100% - ${drawerWidth}px)` } }}>
        <Toolbar />
        <Typography sx={{ fontWeight: 800, fontSize: 16 }}>Dashboard Overview</Typography>
        <Typography sx={{ mb: 2 }}>Welcome to your admin dashboard</Typography>
        ...
        <Grid 
          ...
          >
            <Grid item xs sx={{ flex: 1 }}>
              <Card sx={{ p: 2, borderRadius: 3, boxShadow: 3, width: "100%", backgroundColor: "#fff"}}>
                <CardContent sx={{display: "flex", flexDirection: "column"}}>
                  <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  <Box>
                    <Typography>Customers</Typography>
                    <Typography variant="caption">Customer growth analytics</Typography>
                  </Box>
                  <Button variant="contained" color="primary"><PeopleAltIcon /></Button>
                  </Box>
                    ...
                    <ResponsiveContainer width="100%" height="100%">
                      <AreaChart data={data}>
                        ...
                        <Area
                          ...
                          dot={{ r: 4, stroke: "#ff5722", fill: "#ff5722", strokeWidth: 2 }}
                  ...
                  <Box sx={{ display: "flex", justifyContent: "space-between", mt: 1 }}>
                    <Typography sx={{ color: "green" }}>↑ Positive trend</Typography>
                    <Typography sx={{ color: "text.secondary" }}>Apr – Sep 2025</Typography>
                  </Box>
                </CardContent>
              </Card>
            </Grid>
  ...
  >
      ...
      <Card sx={{ p: 2, borderRadius: 3, boxShadow: 3, width: "100%" }}>
        <CardContent>
          <Box sx={{ display: "flex", justifyContent: "space-between", mb: 1 }}>
            <Typography sx={{ color: "#1e40af", fontWeight: 600 }}>Total Customers</Typography>
            <PeopleAltIcon sx={{ color: "#1e40af", fontSize: 26 }} />
          </Box>
          <Typography sx={{ fontSize: 28, fontWeight: 700 }}>1,210</Typography>
        </CardContent>
      </Card>
    </Grid>
    ...
    <Grid item xs={12} sm={6} md={3} sx={{ flex: 1 }}>
      <Card sx={{ p: 2, borderRadius: 3, boxShadow: 3, width: "100%" }}>
        <CardContent>
          ...
          <Typography sx={{ fontSize: 28, fontWeight: 700 }}>866</Typography>
        </CardContent>
      </Card>
    </Grid>
    ...
    <Grid item xs={12} sm={6} md={3} sx={{ flex: 1 }}>
      <Card sx={{ p: 2, borderRadius: 3, boxShadow: 3, width: "100%" }}>
        <CardContent>
          <Box sx={{ display: "flex", justifyContent: "space-between", mb: 1 }}>
            <Typography sx={{ color: "#1e40af", fontWeight: 600 }}>Item Sold</Typography>
            <PeopleAltIcon sx={{ color: "#1e40af", fontSize: 26 }} />
          </Box>
          <Typography sx={{ fontSize: 28, fontWeight: 700 }}>4,892</Typography>
        </CardContent>
      </Card>
    </Grid>
    ...
    <Grid item xs={12} sm={6} md={3} sx={{ flex: 1 }}>
      <Card sx={{ p: 2, borderRadius: 3, boxShadow: 3, width: "100%" }}>
        <CardContent>
          <Box sx={{ display: "flex", justifyContent: "space-between", mb: 1 }}>
            <Typography sx={{ color: "#1e40af", fontWeight: 600 }}>Revenue</Typography>
            <PeopleAltIcon sx={{ color: "#1e40af", fontSize: 26 }} />
          </Box>
          <Typography sx={{ fontSize: 28, fontWeight: 700 }}>$89.2K</Typography>
        </CardContent>
      </Card>
    </Grid>
  </Grid>
